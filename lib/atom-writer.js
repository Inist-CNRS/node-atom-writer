...
ATOMWriter.prototype = {
  ...
  writeQuery: function (searchTerms, startPage, role) {
    ...
    this.writer.startAttribute('opensearch:searchTerms')
    this.writer.text(searchTerms)
    this.writer.endAttribute()
    this.writer.startAttribute('opensearch:startPage')
    this.writer.text(startPage.toString())
    this.writer.endAttribute()
    this.writer.startAttribute('opensearch:role')
